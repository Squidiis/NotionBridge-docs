document.addEventListener("DOMContentLoaded", () => {
  ...
  // Sidebar toggle für mobile/tablet immer sichtbar machen
  function updateSidebarToggleVisibility() {
    if (window.innerWidth <= 1024) {
      sidebarToggle.style.display = "inline-block";
    } else {
      sidebarToggle.style.display = "none";
      // Sidebar ggf. schließen, wenn auf Desktop gewechselt wird
  ...
  // Sidebar toggle für mobile/tablet
  ...
  if (sidebarToggle && sidebar && sidebarOverlay) {
    ...
    // Hide sidebar if window resized to desktop
